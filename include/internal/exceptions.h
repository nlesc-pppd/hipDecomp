...
#ifndef HIPDECOMP_EXCEPTIONS_H
#define HIPDECOMP_EXCEPTIONS_H
...
#define THROW_INVALID_USAGE(msg)                                                                                       \
  do {                                                                                                                 \
    throw hipdecomp::InvalidUsage(__FILE__, __LINE__, msg);                                                            \
  } while (false)
#define THROW_NOT_SUPPORTED(msg)                                                                                       \
  do {                                                                                                                 \
    throw hipdecomp::NotSupported(__FILE__, __LINE__, msg);                                                            \
  } while (false)
...
public:
  ...
  virtual hipdecompResult_t getResult() const = 0;
...
public:
  ...
  hipdecompResult_t getResult() const override { return HIPDECOMP_RESULT_INVALID_USAGE; }
};
...
public:
  ...
  hipdecompResult_t getResult() const override { return HIPDECOMP_RESULT_NOT_SUPPORTED; }
};
...
public:
  ...
  hipdecompResult_t getResult() const override { return HIPDECOMP_RESULT_MPI_ERROR; }
};
